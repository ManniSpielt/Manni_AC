-- Locales
Manni_AC.IsAdmin = false -- DON'T TOUCH THIS
...
-- MENU 2
local menu2 = MenuV:CreateMenu(false, "Manni_AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Admin Menu')
...
-- MENU 3
local menu3 = MenuV:CreateMenu(false, "Manni_AC: Connected Players", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Connected Players')
...
-- MENU 4
local menu4 = MenuV:CreateMenu(false, "Manni_AC Server Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Server Tools')
...
-- MENU 5
local menu5 = MenuV:CreateMenu(false, "Manni_AC Teleport Options", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Teleport Options')
...
-- MENU 6
local menu6 = MenuV:CreateMenu(false, "Manni_AC Vehicle Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Vehicle Tools')
...
-- MENU 7
local menu7 = MenuV:CreateMenu(false, "Manni_AC Admin Tools", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: TP Tools Tools')
local menu7_acinfo = menu7:AddButton({ icon = 'ℹ️', label = 'AntiCheat Version: 4.0', description = 'discord.com/invite/EAU2DM4hdn' })
local menu7_creatorac = menu7:AddButton({ icon = 'ℹ️', label = 'Manni_AC by VisiBait#0712', description = 'discord.com/invite/EAU2DM4hdn' })
...
-- PRINCIPAL MENU
local menu = MenuV:CreateMenu(false, "Welcome to Manni_AC's Admin Menu", 'centerright', 255, 0, 0, 'size-125', 'example', 'menuv', 'Manni_AC: Main Menu')
...
RegisterCommand('mannimenu', function()
    if Manni_AC.IsAdmin then
        menu:Open()
    end
end, false)

RegisterKeyMapping('mannimenu', "Manni_AC Admin Menu", 'keyboard', 'INSERT')
